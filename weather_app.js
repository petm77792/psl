...
async function getISSData() {
    ...
    const whats_weather_description = data.current.condition.text;
    ...
    var days_of_week = ["Dom", "Seg", "Ter", "Qua", "Qui", "Sex", "Sab"];
    ...
    function search_icon_code(weather_data) {
    ...
    function search_icon_code_forecast1(weather_data) {
        for (let i = 0; i < weather_data.length; i++) {
    ...
    function search_icon_code_forecast2(weather_data) {
        for (let i = 0; i < weather_data.length; i++) {
